...
const Schema: z.ZodType<Prisma.AlbumUncheckedUpdateManyWithoutArtistNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => AlbumUpsertWithWhereUniqueWithoutArtistInputObjectSchema
          ),
          z
            .lazy(
              () => AlbumUpsertWithWhereUniqueWithoutArtistInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => AlbumUpdateWithWhereUniqueWithoutArtistInputObjectSchema
          ),
          z
            .lazy(
              () => AlbumUpdateWithWhereUniqueWithoutArtistInputObjectSchema
...
export const AlbumUncheckedUpdateManyWithoutArtistNestedInputObjectSchema =
  Schema;
