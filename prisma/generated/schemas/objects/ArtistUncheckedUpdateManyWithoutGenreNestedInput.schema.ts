...
const Schema: z.ZodType<Prisma.ArtistUncheckedUpdateManyWithoutGenreNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ArtistUpsertWithWhereUniqueWithoutGenreInputObjectSchema
          ),
          z
            .lazy(
              () => ArtistUpsertWithWhereUniqueWithoutGenreInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => ArtistUpdateWithWhereUniqueWithoutGenreInputObjectSchema
          ),
          z
            .lazy(
              () => ArtistUpdateWithWhereUniqueWithoutGenreInputObjectSchema
...
export const ArtistUncheckedUpdateManyWithoutGenreNestedInputObjectSchema =
  Schema;
