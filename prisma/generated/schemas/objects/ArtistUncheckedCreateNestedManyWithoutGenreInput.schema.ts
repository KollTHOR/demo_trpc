...
const Schema: z.ZodType<Prisma.ArtistUncheckedCreateNestedManyWithoutGenreInput> =
  z
    .object({
      create: z
        .union([
...
export const ArtistUncheckedCreateNestedManyWithoutGenreInputObjectSchema =
  Schema;
